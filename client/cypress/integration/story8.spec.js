...
describe('Insufficient Balance Reminder', () => {
    it('successfully loads', () => {
        ...
        cy.get(':nth-child(6) > .text-center > :nth-child(5) > :nth-child(3)').click({force: true})
        cy.get(':nth-child(6) > .text-center > :nth-child(5) > :nth-child(3)').click({force: true})
        cy.get(':nth-child(6) > .text-center > :nth-child(5) > :nth-child(3)').click({force: true})
        cy.get(':nth-child(6) > .text-center > :nth-child(5) > :nth-child(3)').click({force: true})
        cy.get(':nth-child(6) > .text-center > :nth-child(6) > .btn').click()
