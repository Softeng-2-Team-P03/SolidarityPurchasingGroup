    ...
    return (
        ...
        <>
            ...
            <ListGroup className="prodL">
                {['Apple', 'Cheese', 'Carrots'].map((product) => (
                <ListGroup.Item>
                    <Row>
                        <Col md="2"><Image className="ima" src={ima} rounded /></Col>
                        <Col md="8" ><h4 className="textP">{product}</h4></Col>
                        <Col md="2"><Button  className="buttonEdit" variant="secondary" onClick={() => setShow(true)}>
